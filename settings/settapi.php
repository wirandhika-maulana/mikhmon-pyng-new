...
$id_own="'.$_POST['id_own'].'"; 
?>';
		file_put_contents($ftoken, $token);

//set webhook
		echo "<script>window.location='./admin.php?id=settapi'</script>";
	}
	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h3 class="card-title"><i class="fa fa-handshake-o"></i> Setting ID Telegram </h3>
			</div>
			<div class="card-body">
				<div class="row">
					<div class="col-8">
						<form autocomplete="off" method="post" action="">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title"><i class="fa fa-handshake-o"></i> &nbsp Setting ID Telegram</h3>
								</div>
								<div class="card-body">
									<table class="table table-sm">
										<tr>
											<td class="align-middle">ID Telegram</td>
											<td class="text-right">
													<input class="form-control" id="useradm" type="number" size="20" min="1000" name="id_own" placeholder="Id Telegram Anda" value="<?= $id_own; ?>" >
											</td>
										</tr>
										<tr>
											<td></td>
					...
					<div class="col-4">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title"><i class="fa fa-handshake-o"></i> &nbsp Keterangan</h3>
								</div>
								<div class="card-body">
								<li>API WhatsApp
									<ol>Menggunakan API dari <a href="https://developer.kirimwa.id/api/v1/#pengenalan" title="kirimwa.id" target="_Blank3"><u>kirimwa.id</u></a></ol>
								</li>
								<li>WhatsAuto
									<ol>Menggunakan aplikasi <a href="https://whatsauto.app/" title="whatsauto.app" target="_Blank3"><u>WhatsAuto</u></a>, download di Play Store</ol>
								</li>
								<li>SMS Gateway
									<ol>Menggunakan aplikasi <a href="https://telerivet.com/" title="telerivet.com" target="_Blank3"><u>Telerivet</u></a>, download di Play Store</ol>
								</li>
								<li>PAYMENT GATEWAY
									<ol>Menggunakan API dari <a href="https://tripay.co.id/" title="Tripay.co.id" target="_Blank3"><u>Tripay.co.id</u></a></ol>
								</li>
								<li>Bisa dimodifikasi sesuai API yang dimiliki.</li>
								</div>
							</div>
					</div>
