...
//	$serveractive = $_GET['server'];
	...
	// Filter untuk hanya menampilkan yang statusnya "down"
	$filteredNet = array_filter($getNet, function($net) {
		return isset($net['status']) && $net['status'] === 'down';
	});
				...
				<table id="dataTable" class="table table-bordered table-hover text-nowrap">
					...
					<tbody>
						...
						foreach ($filteredNet as $net) {
							...
							echo "&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp<a title='Ping' href='./?interface=ping&idping=".$net['.id']."&session=".$session."'><i class='fa fa-life-ring' ></i></b>";
							echo "&nbsp&nbsp&nbsp&nbsp <a title='Edit Netwatch Ip ".$net['host']."' href='./?interface=add-netwatch&iphost=".$net['host']."&flag=C&session=".$session."'><i class='fa fa-edit'></i></a>";
							echo "</td>";
