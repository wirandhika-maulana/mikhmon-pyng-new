...
if (!isset($_SESSION["mikhmon"])) {
	...
	if ($hotspot == "dashboard" || substr(end(explode("/", $url)), 0, 8) == "?session") {
		...
		$mpage = "Reseller";
		$umenu = "menu-open";
	} elseif ($hotspot == "active" || $hotspot == "grafik" || $hotspot == "binding-ip" || $removeuseractive != "") {
		$sactive = "active";
...
//disini
	...
	} elseif ($hotspot == "websms") {
		$smsa = "active";
		$mpage = "SMS Gateway";
		$sweb1 = "menu-open";
	} elseif ($hotspot == "webhook") {
		$sweb = "active";
		$mpage = "Setting Telegram Bot";
		$sweb1 = "menu-open";
	} elseif ($hotspot == "wawebhook") {
		$swab = "active";
		$mpage = "Setting WhatsApp Bot";
		$sweb1 = "menu-open";
//	} elseif ($hotspot == "downline") {
//		$sweb = "active";
//		$mpage = "Data Re-Seller";
//		$sweb1 = "menu-open";
		...
		$mpage = $_user_log;
		$lmenu = "menu-open";
	} elseif ($ppp == "secrets" || $ppp == "addsecret"|| $ppp == "add-secret-by-profile" || $ppp == "billing" ||$ppp == "history" || $enablesecr != "" || $disablesecr != "" || $removesecr != "" || $secretbyname != "") {
		$mppp = "active";
		$ssecrets = "active";
		$mpage = $_ppp_secrets;
		$pppmenu = "menu-open";
		...
		$mpage = $_ppp_profiles;
		$pppmenu = "menu-open";
	} elseif ($ppp == "active" || $removepactive != "" || $ppp == "grafik" ) {
		$mppp = "active";
		$spactive = "active";
		$mpage = $_ppp_active;
		$pppmenu = "menu-open";
	} elseif ($ppp == "nonactive" || $removepnonactive != "") {
		$mppp = "active";
		$spnonactive = "active";
		$mpage = $_ppp_non_active;
		$pppmenu = "menu-open";
	} elseif ($ppp == "ppplog") {
		$log = "active";
		$ppplog = "active";
	...
	} elseif ($id == "downline" || $id == "history" || $id == "history1" || $id == "history2") {
		$sweb1 = "active";
		$mpage = "Data Re-Seller";
		$sweb = "menu-open";
...
//setwebhhok
 ?>  
  ...
  <div class="dropdown-container <?= $sweb; ?>">
	<a href="./admin.php?id=whreport" class="menu "> <i class="fa fa-calculator "></i> Bot Report </a>
	<a href="./admin.php?id=webhook" class="menu "> <i class="fa fa-telegram "></i> Telegram Bot </a>
	<a href="./admin.php?id=wawebhook" class="menu "> <i class="fa fa-whatsapp "></i> WhatsApp Bot </a>
  </div>
  <div class="menu spa"></div>
	<a href="./admin.php?id=websms" class="menu <?= $sms; ?>"><i class="fa fa-envelope-o"></i> SMS Gateway</a>
	<a href="./admin.php?id=payment" class="menu <?= $payman; ?>"><i class="fa fa-credit-card"></i> Payment Gateway</a>
	<a href="./admin.php?id=downline" class="menu "> <i class="fa fa-address-card-o "></i> Re-Seller </a> -->
	<a href="./admin.php?id=about" class="menu <?= $sabout; ?>"><i class="fa fa-info-circle"></i> <?= $_about ?></a>

<!-- Social Media Links -->
<!-- <div class="menu spa"></div>
	<h4>Group MimoAssist</h4>
	<a href="https://www.facebook.com/groups/788642016459380/?ref=share&mibextid=NSMWBT" class="menu"><i class="fa fa-facebook"></i> Facebook</a>
	<a href="https://t.me/MimoAssist_Group" class="menu"><i class="fa fa-telegram"></i> Telegram</a>
	<a href="https://chat.whatsapp.com/HOT7cjMRpZrGVI7XM2Fctd" class="menu"><i class="fa fa-whatsapp"></i> WhatsApp</a> -->
...
<div id="sidenav" class="sidenav">
  ...
  <div class="dropdown-container <?= $umenu; ?>">
    ...
    <a href="./?hotspot=reseller&session=<?= $session; ?>" class="<?= $sreseller; ?>"> &nbsp;&nbsp;&nbsp;<i class="fa fa-building"></i> Reseller </a>
  </div>
  <!--profile-->
  ...
  <!--ppp menu secrets--> 
  <div class="dropdown-btn <?= $ssecrets; ?>"><i class="fa fa-users"></i> PPPoE
    <i class="fa fa-caret-down"></i>
  </div>
  <div class="dropdown-container <?= $pppmenu; ?>">
	<a href="./?ppp=active&session=<?= $session; ?>" class="<?= $spactive; ?>"> &nbsp;&nbsp;&nbsp;<i class="fa fa-wifi"></i> <?= $_ppp_active ?></a>
	<a href="./?ppp=nonactive&session=<?= $session; ?>" class="<?= $spnonactive; ?>"> &nbsp;&nbsp;&nbsp;<i class="fa fa-wifi"></i> <?= $_ppp_non_active ?></a>
    <a href="./?ppp=secrets&profile=all&session=<?= $session; ?>" class="<?= $ssecrets; ?>"> &nbsp;&nbsp;&nbsp;<i class="fa fa-user-secret "></i> <?= $_ppp_secrets ?> </a>
	<a href="./?ppp=profiles&session=<?= $session; ?>" class="<?= $spprofile; ?>"> &nbsp;&nbsp;&nbsp;<i class="fa fa-list "></i> <?= $_ppp_profiles ?> </a>
	<a href="./?bbilling=bbilling&session=<?= $session; ?>" class="<?= $bppp; ?>"> &nbsp;&nbsp;&nbsp;<i class="fa fa-money "></i> Billing </a>
  </div>
  <!--quick print-->
  ...
  <div class="dropdown-container <?= $lmenu; ?>">
    ...
    <a href="./?ppp=ppplog&session=<?= $session; ?>" class="<?= $ppplog; ?>"> &nbsp;&nbsp;&nbsp;<i class="fa fa-wifi "></i> PPP Log </a>
  ...
  <!--traffic monitor-->
  <div class="dropdown-btn <?= $moni; ?>"><i class="fa fa-laptop "></i> Monitor 
    <i class="fa fa-caret-down"></i> &nbsp;
  </div>
  <div class="dropdown-container <?= $moni; ?>">
  <a href="./?interface=netwatch&session=<?= $session; ?>" class="menu <?= $strafficmonitor1; ?>"><i class=" fa fa-search-minus"></i> Netwatch </a>
 ...
 <!--about-->
  ...
  <!-- Social Media Links 
<h4>Joint Group MimoAssist</h4>
<a href="#" class="menu"><i class="fa fa-facebook"></i> Facebook</a>
<a href="#" class="menu"><i class="fa fa-telegram"></i> Telegram</a>
<a href="#" class="menu"><i class="fa fa-whatsapp"></i> WhatsApp</a> -->
