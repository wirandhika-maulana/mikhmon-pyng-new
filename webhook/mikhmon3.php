...
//registrasi
		...
		if ($apk=="1") {
			...
			<div class='search-box'>
				<br><input type='text' autocomplete='off' name='cbarang' placeholder='Klik disini...' value=''/>
			...
			echo "<div class='overflow box-bordered mr-t-10' style='max-height: 10vh'>
				...
				<tr><th>NO</th><th>NAMA</th><th>ID WA</th><th>Router</th></tr>";
				for ($i=0 ; $i<count($data) ; $i++)  {
					$isidt=$data[$i];
					$no=$i+1;
					echo "<tr><td>".$no."</td><td>".$isidt['nama_seller']."</td><td>".$isidt['nomer_tlp']."</td><td><b style='color:white;'>".$isidt['status']."</b></td></tr>";
				}
				echo "</table><hr>
			</div>";
		}elseif ($apk=="2")  {
			...
			<tr><td>No WA</td><td>:</td><td>
			<input type='number' name='mnomor' style='font-size:16px;border-radius:5px;font-weight:bold;padding:5px 5px;width:150px;heigh:50px;' maxlength='20' required='1' value='".$mnomor."'>
			</td></tr>
			<tr><td></td><td></td><td>
